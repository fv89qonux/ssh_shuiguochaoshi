...
<div id="MainCenter" align="center" class="MainCenter">
		 ...
		 <div id="content" class="Sub">
				<div class="NewContainer771">
					...
					<div class="Slot" style="position:absolute;overflow:auto;">
						...
						<table width="100%" border="0">
						    ...
						    <tr>
						     ...
						     <tr>
						       <table>
						       	 <s:iterator value="#request.list" id="eva" status="L">
						       	 	<tr>
						       	 		<td colspan="4"><s:property value="${L.index+1}"/>. &nbsp;<s:property value="#eva.conts"/></td>
						       	 	</tr>
						       	 	<tr>
						       	 		<td colspan="4">物流评价：&nbsp;<s:property value="#eva.contswl"/></td>
						       	 	</tr>
						       	 	<tr>
						       	 		<td colspan="4">&nbsp;</td>
						       	 	</tr>
						       	 	<tr>
						       	 		<td>评价人：</td>
						       	 		<td><s:property value="#eva.ename"/></td>
						       	 		<td>&nbsp;&nbsp;&nbsp;评价时间：</td>
						       	 		<td><s:property value="#eva.etime"/></td>
						       	 	</tr>
						       	 	<tr>
						       	 		<td colspan="4">&nbsp;</td>
						       	 	</tr>
